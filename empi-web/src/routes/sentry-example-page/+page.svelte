...
<div>
  <main>
    ...
    <p class="description">
      Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://glitchtip.znamafirma.xyz/organizations/znama-firma-sro/issues/?project=2">Issues Page</a>. 
